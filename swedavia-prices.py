...
# for i in ran1ge (0,5):
    ...
    row = dataID + ',' + flightID +','+ destinationEnglish+','+ destinationIATA+','+ continent+','+countryCode +','+ str(departureTime) +','+ flightStatus +','+ str(distance) +','+ str(emissions) +','+ str(taxCuts) + ',' + str(pricesURL.url) +'\n'
    doc.write(row)
    #+ str(pricesdata) +',' 
...
def CheckStatus():
    ...
    winsound.Beep(480, 100)   
    winsound.Beep(480, 100)   
    threading.Timer(3, CheckStatus).start()
